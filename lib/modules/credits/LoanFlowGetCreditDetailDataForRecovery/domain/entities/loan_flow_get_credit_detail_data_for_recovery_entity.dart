class LoanFlowGetCreditDetailDataForRecoveryResponseEntity {
    final LoanFlowGetCreditDetailDataForRecoveryEntity data;
    final int state;
    final String message;

    LoanFlowGetCreditDetailDataForRecoveryResponseEntity({
        required this.data,
        required this.state,
...
class LoanFlowGetCreditDetailDataForRecoveryEntity {
    ...
    final int currentCreditAmountToPay;
    final int savingAccountCommisionAndTax;
    final String message;
    final bool isValid;
    ...
    LoanFlowGetCreditDetailDataForRecoveryEntity({
