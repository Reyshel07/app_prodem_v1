...
class GetLoanFlowAnnuitiesDetailDataForCreditBloc
    extends
        Bloc<
          GetLoanFlowAnnuitiesDetailDataForCreditEvent,
          GetLoanFlowAnnuitiesDetailDataForCreditState
        > {
  final GetLoanFlowAnnuitiesDetailDataForCreditRepository repository;

  GetLoanFlowAnnuitiesDetailDataForCreditBloc(this.repository)
    : super(GetLoanFlowAnnuitiesDetailDataForCreditInitial()) {
  ...
  Future<void> getLoanFlowAnnDetDatForCredit(
    ...
    try {
      ...
      final response = await repository.getLoanFlowAnnDetDatForCredit(
        token,
        event.idLoanCredit,
        idPerson,
        idUser,
      ...
      if (error.message == "api_logic_error") {
        ...
        emit(
          GetLoanFlowAnnuitiesDetailDataForCreditError(
