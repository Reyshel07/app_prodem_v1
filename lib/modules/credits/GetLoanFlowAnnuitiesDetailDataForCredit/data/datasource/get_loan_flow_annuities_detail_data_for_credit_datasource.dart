...
class GetLoanFlowAnnuitiesDetailDataForCreditDatasource {
  ...
  Future<GetLoanFlowAnnuitiesDetailDataForCreditResponseEntity>getLoanFlowAnnDetDataForCredit(
    String? vToken,
    String? idLoanCredit,
    String? idPerson,
    String? idUser,
    ...
    return GetLoanFlowAnnuitiesDetailDataForCreditResponseModel.fromJson(response);
  }
}